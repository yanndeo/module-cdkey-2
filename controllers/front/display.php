...
class cdkeysdisplayModuleFrontController extends ModuleFrontController
{
    public $auth = true;
    public function __construct()
    {
        ...
        {
            $this->authRedirection = $link->getModuleLink('cdkeys', 'display');
        }
    ...
    public function initContent()
    {
        ...
        $this->setTemplate('module:cdkeys/views/templates/front/m3u.tpl');
    }
}